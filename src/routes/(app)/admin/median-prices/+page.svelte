		...
		<table class="w-full text-left text-sm">
			<thead class="border-b bg-gray-50">
				<tr>
					...
					<th class="px-4 py-3 font-medium text-gray-600">ราคากลาง</th>
			...
			<tbody class="divide-y">
				{#each data.prices as price}
					<tr class="hover:bg-gray-50">
						...
						<td class="px-4 py-3 text-right font-mono">{Number(price.price).toLocaleString('th-TH')} บาท</td>
						<td class="px-4 py-3">{price.province_name}</td>
						<td class="px-4 py-3 text-gray-500">{price.effective_date}</td>
						<td class="px-4 py-3">
